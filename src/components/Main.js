        ...
        <div class="container__right">
          ...
          <div class="content_left">
            ...
            <div class="wrapper__jadwal">
              ...
              <JadwalCard color="rgba(108, 26, 214, 1)" icon={FaHeadset} time="In KU3.07.21, at 08.30 - 10.30" judul="Bahasa Indonesia" name="Agus Suryana" />
              <JadwalCard color="rgba(108, 26, 214, 1)" icon={icons} time="In B4, at 14.30 - 16.30" judul="Pemrograman Berbasis Sensor" />
              <JadwalCard color="#FC5B31" icon={FaShoppingCart} time="In Indomart, at 20.45 - 21.00" judul="Belanja Mingguan" />
